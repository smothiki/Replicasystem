...
class Master(da.DistProcess):
    ...
    def main(self):
        ...
        _thread.start_new_thread(self.checkHealthmsg, ('Thread', 15))
        _thread.start_new_thread(self.messuphead, ('Thread1', 4))
        _thread.start_new_thread(self.messuptail, ('Thread2', 7))
        _thread.start_new_thread(self.messupserver, ('Thread3', 1, 9))
        _st_label_53 = 0
        while (_st_label_53 == 0):
            _st_label_53 += 1
            if False:
                _st_label_53 += 1
            else:
                super()._label('_st_label_53', block=True)
                _st_label_53 -= 1
    ...
    def messupserver(self, threadName, index, timetokill):
        ...
        self.output('killing server')
        self.serverisAlive[index] = 0

    def _Master_handler_0(self, serverId, p):
        self.output(('healthcheck received%r.' % serverId))
...
class Server(da.DistProcess):
    ...
    def main(self):
        ...
        while (_st_label_67 == 0):
            ...
            if ExistentialOpExpr_0():
                ...
                _st_label_67 -= 1
        _st_label_68 = 0
        while (_st_label_68 == 0):
            _st_label_68 += 1
            if False:
                _st_label_68 += 1
            else:
                super()._label('_st_label_68', block=True)
                _st_label_68 -= 1
    ...
    def _Server_handler_3(self, request, p):
        ...
        if (self.index < self.endindex):
            ...
            self.output('sending reply to client')
...
class Client(da.DistProcess):
    ...
    def main(self):
        ...
        while (_st_label_112 == 0):
            ...
            if False:
                ...
                super()._label('_st_label_112', block=True, timeout=20)
                _st_label_112 -= 1
    ...
    def _Client_handler_5(self, index, p):
